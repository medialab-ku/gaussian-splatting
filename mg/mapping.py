    ...
    def Map(self, tracking_result_instance):
        ...
        if not tracking_result_instance[1]: #First KF
            ...
            if self.CheckSuperPixelFrame(keyframe_pose):
                ...
                point_list_for_gaussian = self.TMPConvertCamera2World(ref_3d_list, prev_pose)

                return ([True, True, rgb, gray, KF_xyz, keyframe_pose, point_list_for_gaussian, ref_color_list])
            else:
                return ([False])
